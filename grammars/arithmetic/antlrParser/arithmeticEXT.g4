...
main_dummy_rule_hope_for_no_collisions : start+ 
{
...
start : exp { _25a67066_8c4d_4a6b_9eb7_57b187a6ef3b++; };   

exp : term { _84c9ec57_f716_4df2_9720_454d02974ba8++; } | exp '-' term { _ed4c3af8_ba43_4abc_93a3_263acf446903++; } | exp '+' term { _16f8c1e5_f3e7_412e_8297_320510778a62++; };   

term : term '/' factor { _0dc2d63a_0ccf_40ca_9807_c4e7ff9b830c++; } | term '*' factor { _bfc12918_db0c_40bc_84df_98481fcb11ec++; } | factor { _cc82d6ad_25ed_460f_a9c9_d64bdc47586d++; };   

factor : '+' factor { _e91a1ede_82b9_4180_ada2_d5608aef67b5++; } | '(' exp ')' { _cdd6587e_5c46_4048_bab1_3b75bb0daa4c++; } | digitrec { _6e6682fc_4517_4b8b_ad5f_64461ba3ed7b++; } | '-' factor { _58389b8d_df39_4f1b_b749_e6927ae792e4++; };   

digitrec : bool { _5d175fcf_7a7b_428f_96ad_205aba37c7e5++; } | digit { _c07ca19a_b839_4480_83cc_35933bf57c6d++; } | digit digitrec { _8e079b6b_87a2_429b_b4be_820e1fc39507++; };   

digit : '4' { _0e615a7b_f485_436f_9864_b3705e7b6a35++; } | '5' { _3007af0c_d472_4b02_8dfe_6458ee4dd16b++; } | '0' { _3865f17e_d1ac_460c_b791_5e321bf40b8e++; } | '1' { _cf60f941_8297_47e7_93d3_14a5d2cfb58a++; } | '3' { _0debc092_3675_41e0_8b4a_425efd383094++; } | '8' { _15408aa6_088b_4b48_a7f0_04e8898cee35++; } | '7' { _aca820eb_5a72_4941_b593_63d459e0180d++; } | '9' { _1a682da2_5101_4388_8e2e_00900a51ff49++; } | '6' { _acc6bd49_041c_4dce_9a3d_eefa92b34e6d++; } | '2' { _70bdf0f7_701f_46e2_a157_ba55bfad7772++; };   

bool : 'f' 'a' 'l' 's' 'e' { _0b697d8c_00a4_4262_acb2_021ebe124eae++; } | 'n' 'u' 'l' 'l' { _943aa8c3_767e_44a6_9fa7_69de86eef832++; } | 'true' { _9e12b4ff_e74d_4097_9cb0_23746944f381++; };   
Whitespace: (' '|'\n'|'\t'|'\r')+ -> skip;
