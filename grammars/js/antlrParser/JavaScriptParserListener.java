...
public interface JavaScriptParserListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#main_dummy_rule_hope_for_no_collisions}.
	 * @param ctx the parse tree
	 */
	void enterMain_dummy_rule_hope_for_no_collisions(JavaScriptParser.Main_dummy_rule_hope_for_no_collisionsContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#main_dummy_rule_hope_for_no_collisions}.
	 * @param ctx the parse tree
	 */
	void exitMain_dummy_rule_hope_for_no_collisions(JavaScriptParser.Main_dummy_rule_hope_for_no_collisionsContext ctx);
	/**
